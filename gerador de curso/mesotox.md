...
- [Protocolo](https://drive.google.com/file/d/1TgXvVWt7__eywpa6mMejesFR2Fp2k0nZ/view?usp=drive_link)
...
#### Pergunta: O mesotox solution® (c.prof 213®) promove efeito semelhante à toxina botulínica através de:
- [ ] Estimulação direta do colágeno tipo I
- [ ] Aumento da melanogênese
- [x] Inibição da liberação de acetilcolina
- [ ] Paralisia permanente do músculo

#### Pergunta: O peptídeo acetil hexapeptídeo-8® atua principalmente:
- [ ] Bloqueando os canais de sódio da membrana muscular
- [ ] Aumentando a produção de melanina
- [x] Competindo com a proteína SNAP-25 no complexo SNARE
- [ ] Degradando ácido hialurônico

#### Pergunta: Qual das seguintes funções não está associada à nicotinamida?
- [ ] Clareamento da pele
- [ ] Estímulo de colágeno
- [x] Aumento da inflamação cutânea
- [ ] Reforço da barreira epidérmica

#### Pergunta: O peptídeo pentapeptídeo-18® age:
- [ ] Estimulando a contração muscular
- [x] Inibindo a entrada de cálcio nos neurônios motores
- [ ] Rompendo as fibras de elastina
- [ ] Estimulando melanócitos

#### Pergunta: O protocolo indicado para o uso do c.prof 213® mesotox solution® é:
- [ ] 10 sessões, 1 vez ao mês
- [x] 5 sessões com intervalo quinzenal
- [ ] Aplicação única sem manutenção
- [ ] Uso contínuo diário por 30 dias

#### Pergunta: A principal função da nicotinamida na fórmula do c.prof 213® mesotox solution® é:
- [ ] Paralisar a musculatura facial de forma definitiva
- [x] Clarear manchas, reforçar a barreira cutânea e estimular colágeno
- [ ] Inibir a formação do complexo SNARE
- [ ] Romper a membrana celular

#### Pergunta: Qual é o benefício de associar o mesotox® à toxina botulínica?
- [ ] Reversão imediata do efeito da toxina
- [ ] Redução da ação muscular profunda
- [x] Potencialização dos resultados e início mais rápido do efeito
- [ ] Inibição completa da movimentação muscular facial

#### Pergunta: A liberação de acetilcolina é mediada por:
- [ ] Vesículas contendo queratinócitos
- [x] Formação do complexo SNARE
...
#### Pergunta: A combinação dos peptídeos com nicotinamida resulta em:
- [ ] Inibição da síntese de ceramidas
- [ ] Perda da barreira epidérmica
- [x] Ação clareadora, firmadora e calmante
