...
- [Protocolo](https://drive.google.com/file/d/10p5w2u998pW3r4iY-Yc49JpM3g5jyFm6/view?usp=drive_link)
- [Produto](https://drive.google.com/file/d/1p2aofdRY14mH9x61Wz-wZeuWZ-GI9sw8/view?usp=drive_link)
- [Antes e Depois](https://drive.google.com/file/d/1DNecTGRAkkx19EDyfgBjW3SS7BklL1lx/view?usp=drive_link)
- [Cápsula do Conhecimento](https://drive.google.com/file/d/1NFkEZqg11NS4bSMvAFxj6IvsF_FY9hf9/view?usp=drive_link)
- [Estudo Clínico - cicatrizes hipotróficas](https://drive.google.com/file/d/1e1RoJc-RLq_y2cCK8D0V7SpGQGouxNXG/view?usp=drive_link)
- [Estudo Clínico - Redução de cicatrizes atróficas pós-acne com polinucleotídeos](https://drive.google.com/file/d/1BK64WHUu92s3pXf7RVr_z5NDZoHKvtWj/view?usp=drive_link)

## Quiz: Avaliação Final
- **Duração:** 20 minutos
- **Nota de corte:** 80%

#### Pergunta: O skinmark solution® é indicado principalmente para:
- [ ] Hidratação superficial e brilho imediato
- [x] Correção de estrias, cicatrizes e remodelação dérmica
- [ ] Controle de oleosidade
- [ ] Clareamento leve da epiderme

#### Pergunta: Qual ativo do skinmark® tem ação de reparo celular e regeneração profunda?
- [ ] Darutosídeo
- [ ] Chlorella vulgaris
- [x] PDRN (X-DNA)
- [ ] Ácido hialurônico

#### Pergunta: O silício orgânico® promove, entre outros benefícios:
- [ ] Redução da melanina por bloqueio da tirosinase
- [x] Estabilização da tripla hélice de colágeno e aumento da firmeza
- [ ] Diminuição de oleosidade
- [ ] Aumento de MMPs

#### Pergunta: O darutosídeo® é um ativo conhecido por:
- [ ] Hidratar a epiderme profundamente
- [x] Estimular microcirculação e reorganização dérmica
- [ ] Reduzir apenas pigmentação
- [ ] Controlar oleosidade na zona T

#### Pergunta: Sobre o mecanismo do PDRN (X-DNA®), assinale a alternativa correta:
- [ ] Atua apenas na camada córnea
- [ ] Inibe VEGF e reduz circulação
- [x] Estimula angiogênese e aumenta oxigenação tecidual
- [ ] Atua apenas como antioxidante leve

#### Pergunta: O ativo chlorella vulgaris® contribui principalmente para:
- [ ] Aumento da oleosidade
- [x] Fortalecimento da junção dermoepidérmica e estímulo de colágeno
- [ ] Escurecimento da pele
- [ ] Reduzir sensibilidade

#### Pergunta: Sobre o protocolo profissional do skinmark solution®, é correto afirmar:
- [ ] Não deve ser associado ao m.pen [pro]®
- [ ] É aplicado sempre após peelings agressivos
- [x] Deve ser aplicado simultaneamente ao uso da m.pen [pro]®
- [ ] Deve ser aplicado apenas no final da sessão

#### Pergunta: Nº recomendado de sessões do skinmark solution®:
- [ ] 1 a 2 sessões
- [ ] 3 sessões semanais
